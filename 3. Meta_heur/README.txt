...
Para compilar y ejecutar:
	...
	python3 N_Reinas.py archivo.txt

En la parte de "archivo.txt" se coloca el nombre del archivo a ejecutar de los contenidos en la carpeta "Ejemplares".
